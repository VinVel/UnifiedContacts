...
object MimeTypes {
    ...
    const val POSTAL_ADDRESS = "vnd.android.cursor.item/postal-address_v2"
    ...
    const val READ_ONLY = "vnd.android.cursor.item/vnd.net.velcore.unifiedcontacts.read-only"
}